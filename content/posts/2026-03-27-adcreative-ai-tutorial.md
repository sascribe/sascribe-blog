...
1. **Ad Platform**: Facebook, Instagram, Google Display, LinkedIn, Pinterest, Twitter, or generic.
2. **Ad Size/Format**: Depending on the platform, you'll see options like 1080x1080 (Instagram feed), 1200x628 (Facebook feed), 300x250 (Google Display), and many more.
3. **Creative Type**: Static image, video creative, or product-focused ad (for e-commerce).
